...
<div class="container" style="margin-top: 10px;min-height: 600px;">
    ...
    <div class="row">
        ...
        ?>
          ...
          <!-- <h1><?php echo $customer->FNAME .' '.$customer->MNAME.' '.$customer->LNAME; ?>  </h1> -->
<?php 
    // if ($view =="message") { 
...
?>  
        ...
        <li class="<?php echo  $_SESSION['appliedjobs']; ?>"><a href="<?php echo web_root.'customer/index.php?view=appliedjobs'; ?>" >Applied Jobs</a></li> 
        <li class="<?php echo  $_SESSION['accounts'];  ?>"><a href="<?php echo web_root.'customer/index.php?view=accounts'; ?>" >Accounts</a></li> 
      </ul>
