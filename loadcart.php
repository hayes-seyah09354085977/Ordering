                    ...
                    for ($i=0; $i < $count_cart  ; $i++) { 
                      // print_r($_SESSION['gcCart']);
                        	echo'<tr> 
                    				...
                    				<td><input style="height:25px;width:50px; border:none;" type="number" name="qty" id="'.$_SESSION['gcCart'][$i]['productID'].'qty" required class="cartqty" min="1" data-id="'.$_SESSION['gcCart'][$i]['productID'].'"  value="'.$_SESSION['gcCart'][$i]['qty'].'" autocomplete="off" /> </td>
